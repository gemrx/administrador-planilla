...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/planilla.css">
    <script src="../assets/js/libraries/code.jquery.com_jquery-3.7.1.min.js"></script>
    <script defer src="../assets/js/planilla.js"></script>
...
<body>
    <nav class="dashboard">
        ...
        <ul class="pages-container">
            ...
            <li class="page modificar" onclick="window.location.href = 'modificar.php'">
            ...
            <li class="page planilla active" onclick="window.location.href = 'planilla.php'">
