...
<head>
    ...
    <script defer src="assets/js/registrar.js"></script>
...
<body>
    <nav class="dashboard">
        ...
        <ul class="pages-container">
            ...
            <li class="page modificar" onclick="window.location.href = 'vistas/modificar.php'">
                ...
                <a href="vistas/modificar.php">Modificar Empleado</a>
            </li>
            <li class="page planilla" onclick="window.location.href = 'vistas/planilla.php'">
                ...
                <a href="vistas/planilla.php">Planilla</a>
            </li>
        </ul>
    </nav>
    <main>
